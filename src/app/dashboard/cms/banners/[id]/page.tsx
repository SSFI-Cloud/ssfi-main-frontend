    ...
    const load = async () => {
      try {
        ...
        if (b.metadata) {
          const m = b.metadata;
          setMeta({
            badge: m.badge || '', highlight: m.highlight || '', stroke: m.stroke || '', description: m.description || '',
          ...
          if (m.badge || m.highlight || m.stroke || m.description || m.secondaryCtaText || m.secondaryCtaLink || m.ghostWord) {
