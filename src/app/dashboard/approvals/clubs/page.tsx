                    ...
                    >
                        ...
                        >
                            <div className="p-6 border-b border-gray-200 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <div className="relative w-12 h-12 rounded-xl border border-gray-200 bg-gray-50 flex items-center justify-center overflow-hidden flex-shrink-0">
                                        {viewingClub.logo_path ? (
                                            <>
                                                ...
                                                />
                                                <DownloadButton
                                                    url={viewingClub.logo_path}
                                                    filename={`${viewingClub.club_name || 'club'}-logo`}
                                                    variant="overlay"
                                                    label="Download logo"
