...
export default function DistrictViewModal({ district, isLoading, onClose }: DistrictViewModalProps) {
    return (
        <AnimatePresence>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-lg font-bold text-gray-900 leading-tight">
                                    {district?.district_name || 'Loading...'}
                                </h2>
                                <p className="text-xs text-gray-600">
                                    {district ? `${district.state_name} · ${district.state_code}` : 'District Details & Secretary Information'}
                                </p>
                            </div>
                        </div>
                        <button
                            ...
                            <div className="p-6 space-y-6">
                                ...
                                {district.secretary ? (
                                    <div className="space-y-0 divide-y divide-gray-100">
                                        ...
                                        <div className="flex items-center gap-4 p-4 bg-white rounded-xl border border-gray-200 shadow-sm">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center gap-2 flex-wrap">
                                                    <h3 className="text-gray-900 font-semibold text-base">{district.secretary.name}</h3>
                                                    <StatusBadge status={district.secretary.membershipStatus} />
                                                </div>
                                                <p className="text-gray-600 text-sm mt-0.5">District Secretary — {district.district_name}</p>
                                        ...
                                        <div>
                                            ...
                                            <div className="bg-white rounded-xl border border-gray-200 px-4">
                                                ...
                                                <Field icon={Mail} label="Email" value={district.secretary.email} />
                                                <Field icon={MapPin} label="Address" value={district.secretary.residentialAddress} />
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div className="bg-white rounded-xl border border-gray-200 px-4">
                                                <Field
                                                    ...
                                                    value={formatDate(district.secretary.registrationDate)}
                                                />
                                                <Field
                                                    icon={Clock}
                                                    label="Expiry Date"
                                                    value={formatDate(district.secretary.expiryDate)}
                                                />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="text-center py-8 text-gray-600 bg-gray-50 rounded-xl border border-gray-100">
                                        ...
                                        <p className="text-sm">No approved secretary registered for this district</p>
                                    </div>
                                )}
                            </div>
                        )}
